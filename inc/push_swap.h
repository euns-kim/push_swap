...
/**** mandatory part only functions – push_swap ****/

/** mini sorting for 2-5 elements **/
...
/** for indexing and initiating stacks **/
...
/** for examining the outcome **/
int		is_sorted(t_st a, t_st b);

/** for freeing memory space **/
